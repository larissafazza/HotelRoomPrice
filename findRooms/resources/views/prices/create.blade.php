        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    {{ __('Insert the price and date informations') }}
                </div>

                <div class="card-body">
                    <form class="hotel-form" method="post" action="{{ route('prices.store') }}" id="create-form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group form-div">
                            ...
                            <input class="input-form form-control" id="form-date" name="start_date" type="date" required>
                        </div>
                        <div class="form-group form-div">
                            <label class="label">End date of this value</label>
                            <input class="input-form form-control" id="form-date" name="end_date" type="date" required>
                        </div>
                        <div class="form-group form-div">
                            <label class="label">Price</label>
                            <input class="input-form form-control" id="form-price" name="price" type="number" step="0.01" required>
                        </div>
